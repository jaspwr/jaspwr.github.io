...
* @returns {string}
*/
export function wasm_compile(files) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.wasm_compile(retptr, ptr0, len0);
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_file_unwrap = function(arg0) {
        const ret = File.__unwrap(takeObject(arg0));
        return ret;
    };
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('lilac_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
